...
//#if NEWCODE1
		...
		protected RecFileModeType recFileMode = RecFileModeType.Wma;
...
//#if NEWCODE1
				...
				// right now!
				// Another solution is to configure the Asf file writer,
				// however DShowNET does not have the interface that is needed.
				// Please ensure it is added. 
...
//#if NEWCODE1
			...
			public interface IConfigAsfWriter
		{
			...
			/// Obsolete?
			[PreserveSig]
			int ConfigureFilterUsingProfileGuid([In, MarshalAs(UnmanagedType.LPStruct)]
				Guid guidProfile);
