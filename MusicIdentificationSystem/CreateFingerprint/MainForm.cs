...
namespace CreateFingerprint
{
    public partial class MainForm : System.Windows.Forms.Form
    {
        ...
        public void StoreAudioFileFingerprintsInStorageForLaterRetrieval(string pathToAudioFile)
        {
            ...
            fingerprint.StoreAudioFileFingerprintsInStorageForLaterRetrieval(pathToAudioFile);
        ...
        public void GetBestMatchForSong(string audioFile)
        {
            ...
            List<ResultEntity> results = fingerprint.GetBestMatchForSong(audioFile, confidfence);
            sw.Stop();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            TrackList.Clear();
            Fingerprint fingerprint = new Fingerprint();
            List<ResultEntity> results = fingerprint.GetMatchSongsFromFolder(textBox3.Text, confidfence);
